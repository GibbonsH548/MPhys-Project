...
for i in range(it):
    X = rng.normal(loc = 0, scale = 1000, size = N) # N positions of coordinates in x cartesian directions
    Y = rng.normal(loc = 0, scale = 1000, size = N) # N positions of coordinates in y cartesian directions
    Z = rng.normal(loc = 0, scale = 10, size = N) # N positions of coordinates in z cartesian directions
